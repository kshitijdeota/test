...
const classPlugin = require('markdown-it-class')
...
module.exports = function(eleventyConfig, options) {
  ...
  const anchorOptions = {
    level: [1,2],
    slugify: eleventyConfig.javascriptFunctions.slugify,
  }
  ...
  /**
   * Attaches classes to running markup structures 
   * @see https://github.com/kamranahmedse/markdown-it-class
   **/
  const classOptions = {
    p: ['paragraph']
  } 
  ...
  /**
   * Override footnote_open to insert ordinals
   * TODO: Move this to basIssue
   **/
  markdownLibrary.renderer.rules.footnote_open = (tokens, idx, options, env, slf) => {
    ...
    return '<li id="fn' + id + '" class="footnote-item"><span class="footnote-id">'+id+'</span>';
  }
