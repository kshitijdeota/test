...
const basIssuePlugin = require('~plugins/basIssue')
...
const envPublicationUrl = require('~plugins/envPublicationUrl')
...
module.exports = function(eleventyConfig) {
  ...
  let globalData = globalDataPlugin(eleventyConfig, { inputDir, outputDir, publicDir })
  // NB: envPublicationUrl mutates `globalData` so must execute first
  envPublicationUrl(eleventyConfig,globalData)
  ...
  eleventyConfig.addPlugin(basIssuePlugin,collections,globalData)
