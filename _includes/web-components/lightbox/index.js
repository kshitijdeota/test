...
class Lightbox extends LitElement {
  ...
  _alignSlideData(figure) {
    ...
    const unescapedFigureElement = figureElementContent.replaceAll('&amp;','&').replaceAll('&lt;','<')
                                                        .replaceAll('&gt;','>').replaceAll('&quot;','"');
    return { ...figure, isAudio, isVideo, aspectRatio, figureElementContent: unescapedFigureElement }
  }
